    ...
    <div className="contacts-page">
      ...
      <div className="contacts-page-content">
        ...
        <div className="contacts-page-text">
          ...
          <p><b>Address:</b> 123 Main Street Phoenix, AZ 85001 United States</p>
          <p><b>Phone:</b> +1 (555) 555-5555</p>
          <p><b>Email:</b> info@jsdosneakers.com</p>
          <p><b>Website:</b> www.jsdosneakers.com</p>
          <p><b>Company Description:</b> Sports Sneakers - your reliable partner in the world of sneakers and athletic footwear. 
