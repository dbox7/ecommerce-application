...
export const AboutUsPage: FC = () => {
  ...
  return (
    <div className={styles['about__content']}>
      <h1 className={styles['about__content__title']}>About Us</h1>
      <div className={styles['about__content__text']}>
        {user.firstName ? 
          <p>Hey there,&nbsp; 
            <Link to="/profile/:user" className={styles['about__content__text__text-link']} target="_blank">
              <b>{user.firstName}!</b>
            </Link>
          </p> :
          <p>Hey there,&nbsp; 
            <Link to="/signup" className={styles['about__content__text__text-link']} target="_blank">
              <b>username!</b>
            </Link>
          </p>
        }
        ...
        <b>
            <Link to="https://rs.school/" className={styles['about__content__text__text-link']} target="_blank"> 
            RS-School
          </Link>
          </b>. 
        ...
        <br/>
        <h2 className={styles['about__content__sub-title']}>Who are we</h2> 
        <div className={styles['about__content__team']}>
          {developers.map((developer, index) => <CDeveloperCard key={index} developer={developer} />)}
        </div>
        <h2 className={styles['about__content__sub-title']}>How we did IT</h2>
        ...
        <p>We're open to feedback and value diverse perspectives. If you have suggestions or observations, let us know. 
          The&nbsp;
        <b><Link to="/contacts" 
            className={styles['about__content__text__text-link']} 
        ...
        <Link to="https://rs.school/" target="_blank"><div className={styles['about__content__text__school-logo']}></div></Link>
      </div>
    </div>
  );
